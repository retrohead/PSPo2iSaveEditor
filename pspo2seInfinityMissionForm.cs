...
// Type: pspo2seSaveEditorProgram.pspo2seInfinityMissionForm
...
namespace pspo2seSaveEditorProgram
{
  public class pspo2seInfinityMissionForm : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (pspo2seInfinityMissionForm));
      ...
      this.imgListMaps.ImageStream = (ImageListStreamer) componentResourceManager.GetObject("imgListMaps.ImageStream");
      ...
      this.imgListAreaThemes.ImageStream = (ImageListStreamer) componentResourceManager.GetObject("imgListAreaThemes.ImageStream");
      ...
      this.imgListBoss.ImageStream = (ImageListStreamer) componentResourceManager.GetObject("imgListBoss.ImageStream");
      ...
      this.Name = nameof (pspo2seInfinityMissionForm);
